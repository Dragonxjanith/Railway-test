...
const { imageToWebp, videoToWebp, writeExifImg, writeExifVid } = require('./nima/exif')
const { smsg, isUrl, generateMessageTag, getBuffer, getSizeMedia, fetchJson, await, sleep } = require('./nima/myfunc')
...
*/
    ...
    ElisaBotMd.sendMedia = async (jid, path, fileName = '', caption = '', quoted = '', options = {}) => {
       ...
       if (options.asSticker || /webp/.test(mime)) {
        let { writeExif } = require('./nima/exif')
